      ...
      <section className="home" id="home">
        ...
        <div className="image-container">
          <div className="playing-cards">
            <img src="img1.jpeg" alt="Profile 1" className="playing-card" />
            <img src="img2.jpeg" alt="Profile 2" className="playing-card" />
            <img src="img3.jpeg" alt="Profile 3" className="playing-card" />
            <img src="img4.jpeg" alt="Profile 4" className="playing-card" />
          </div>
        </div>
      </section>
    </>
