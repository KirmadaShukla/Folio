...
const App = () => {
  ...
  useEffect(() => {
    ...
    const texts = ["Pranjal Shukla", "Software developer", "AI Automation Engineer"];
    let textIndex = 0;
    let charIndex = 0;
  ...
  return (
    <>
      ...
      <footer className="footer capitalize"> created by <span> mr. pranjal shukla</span> | all rights reserved! </footer>
